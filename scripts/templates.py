...
# Stroke icons inherit the surrounding text colour; "cap" takes an explicit
# fill so the Orange/Purple cap awards render in their signature colours.
_ICONS = {
    "trophy": ("stroke",
    ...
    "cap": ("fill",
            '<path d="M12 3.5c-4.7 0-8.5 3.6-8.5 8 0 .35.02.7.07 1.04h16.86c.05-.34.07-.69.07-1.04 0-4.4-3.8-8-8.5-8Z"/>'
            '<path d="M3.7 13.04C2.1 13.3 1 14 1 15.05 1 16.4 2.9 17 5.2 17h6.05a.95.95 0 0 0 .95-.95v-3.01H3.7Z"/>'),
}


def icon(name, cls="w-5 h-5", color=None):
    """Return an inline SVG icon. color overrides the default currentColor."""
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
  <a href="{up}" class="flex items-center gap-2 shrink-0">
    <svg width="36" height="36" viewBox="0 0 64 64" class="shrink-0" aria-hidden="true"><defs><radialGradient id="cshball" cx="40%" cy="35%" r="60%"><stop offset="0%" stop-color="#A52A2A" stop-opacity="0.3"/><stop offset="100%" stop-color="#4A0E0E" stop-opacity="0.3"/></radialGradient></defs><circle cx="32" cy="32" r="28" fill="#8B1A1A"/><circle cx="32" cy="32" r="28" fill="url(#cshball)"/><path d="M14 20 Q24 32 14 44" fill="none" stroke="#F5E6D0" stroke-width="2.2" stroke-linecap="round"/><path d="M50 20 Q40 32 50 44" fill="none" stroke="#F5E6D0" stroke-width="2.2" stroke-linecap="round"/><line x1="11" y1="23" x2="17" y2="25" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="10" y1="28" x2="16" y2="29" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="10" y1="33" x2="15.5" y2="33" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="10" y1="38" x2="16" y2="37" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="11" y1="42" x2="17" y2="40" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="53" y1="23" x2="47" y2="25" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="54" y1="28" x2="48" y2="29" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="54" y1="33" x2="48.5" y2="33" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="54" y1="38" x2="48" y2="37" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/><line x1="53" y1="42" x2="47" y2="40" stroke="#F5E6D0" stroke-width="1.4" stroke-linecap="round"/></svg>
