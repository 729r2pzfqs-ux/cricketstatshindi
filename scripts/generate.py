...
def write_static():
    ...
    (OUT / "favicon.svg").write_text(
        ...
        '<path d="M8 24L22 10" stroke="#fff" stroke-width="2.5" stroke-linecap="round"/>'
        '<circle cx="10" cy="22" r="3.2" fill="#a4161a"/>'
        '<path d="M18 8l6 6" stroke="#fff" stroke-width="2.5" stroke-linecap="round"/></svg>')
    # search.js
